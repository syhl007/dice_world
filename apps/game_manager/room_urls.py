...
urlpatterns = [
    ...
    path('<uuid:room_id>/invitate/<uuid:user_id>', login_required(room_views.InvitateToGame.as_view()), name='invitate_user'),
    ...
    path('<uuid:room_id>/lost/task/', login_required(room_views.ItemLost.as_view()), name='lost_item'),
